...
//Declarations
#define LCD_DATA    P2				//LCD data port to PORTD
...
void LCD_data(unsigned char  val);		//Function to write character to the LCD
...
void main(void)
{     
     char var1[] = "sir we r ";//Declare message to be displayed
     char var2[] = "late for BUS";
...
void LCD_data(unsigned char val)//Function to write data to the LCD
{
    LCD_DATA = val;	//Send data on LCD data bus
